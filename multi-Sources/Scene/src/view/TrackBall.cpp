...
// ------------------------------------------------------------------------------------------------
void TrackBall::update( UpdateEvent m, const Math::ivec2 &screenPos )
{
	switch( m )
	{
	case UpdateEvent::DragBegin:  _startPoint = mapToSphere( screenPos ); break;
	case UpdateEvent::DragEnd:    _prevQ = _currQ;                        break;
	case UpdateEvent::DragUpdate: update( screenPos );                    break;
	}
}
