...
// ------------------------------------------------------------------------------------------------
struct RENDERENGINE_API SceneEvent
{
	SceneEvent();
...
// ------------------------------------------------------------------------------------------------
struct RENDERENGINE_API SceneMouseEvent : public SceneEvent
{
	enum Action : int
	{
		ActionNone    = 0x0000, 
	...
	RenderSystem::Picker::Value pickValue        = RenderSystem::Picker::kInvalidValueBegin;
	int                         pickPart         = 0;
};
