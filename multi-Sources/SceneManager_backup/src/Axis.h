// Axis.h
//
#ifndef RENDERENGINE_AXIS_H
#define RENDERENGINE_AXIS_H
...
class RENDERENGINE_API Axis : public SceneObject
{
public:
...
public:
	...
	void draw( const RenderSystem::Surface &surface, const RenderSystem::DrawState &ds ) const override;
