...
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Core_API.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Color.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\DateTime.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\FileSystem.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Json.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Log.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\LRUCache.h .
