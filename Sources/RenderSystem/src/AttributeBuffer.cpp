...
void AttributeBuffer::attach( int loc )
{
	...
	case AttributeBuffer::Byte: 
	case AttributeBuffer::UnsignedByte:
	case AttributeBuffer::Short:
	case AttributeBuffer::UnsignedShort:
	case AttributeBuffer::Int:
	case AttributeBuffer::UnsignedInt:
	...
	case AttributeBuffer::Float:
	case AttributeBuffer::HalfFloat:
	case AttributeBuffer::Double: // tbd glVertexAttribLPointer
	default:
