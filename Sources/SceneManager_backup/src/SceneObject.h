...
#include "RenderSystem/DrawState.h"
...
class RENDERENGINE_API SceneObject : public std::enable_shared_from_this<SceneObject>
{
public:
...
public:
	...
	virtual void			 draw( RenderSystem::Surface &surface, const RenderSystem::DrawState &ds ) const;

protected:
	void                     prepareForPicking( RenderSystem::Surface &surface, RenderSystem::DrawState &ds ) const;
	virtual void			 doDraw( RenderSystem::Surface &surface, RenderSystem::DrawState &ds ) const {};
