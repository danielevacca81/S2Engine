...
ProjectionTransform ProjectionTransform::createOrthographic( double left, double right, double bottom, double top, double nearPlane, double farPlane )
{
	ProjectionTransform pt;
	{
		...
		pt._fov          = 90.0; // orthographic projection does not have a field of view, but we set it to 180 degrees.
		pt._fovHorizonal = 90.0; // orthographic projection does not have a field of view, but we set it to 180 degrees.
		pt._leftPlane    = left;
