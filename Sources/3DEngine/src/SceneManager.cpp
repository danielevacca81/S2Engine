...
void SceneManager::logEvent( std::shared_ptr<ObjectInteraction> &o, const MouseEventObj &evObj, const char *str )
{
	...
	std::cout << " pickValue:";
	if( ev.pickValue == Renderer::Picker::kClearValue )
		std::cout << "kClearValue";
	else if( ev.pickValue >= Renderer::Picker::kInvalidValueBegin )
		std::cout << "kInvalidValueBegin+" << ev.pickValue-Renderer::Picker::kInvalidValueBegin;
