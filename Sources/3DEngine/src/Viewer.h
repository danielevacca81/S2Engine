...
public:
	Viewer() : _applyConstraintsInProgress( false ) {}
...
protected:
	...
	bool	                  _applyConstraintsInProgress;
...
// ------------------------------------------------------------------------------------------------
class S2SCENE_API ViewerOrthographic : public Viewer
{
public:
...
// ------------------------------------------------------------------------------------------------
class S2SCENE_API Viewer2D : public ViewerOrthographic
{
public: 
...
// ------------------------------------------------------------------------------------------------
class S2SCENE_API ViewerPerspective : public Viewer
{
public:
	enum class FovId
	{
...
// ------------------------------------------------------------------------------------------------
class S2SCENE_API Viewer3D : public ViewerPerspective
{
public:
