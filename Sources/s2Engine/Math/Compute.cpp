...
namespace glm::Compute {

//-------------------------------------------------------------------------------------------------
bool lineIntersection( const dvec2& a1, const dvec2& a2, const dvec2& b1, const dvec2& b2, dvec2* out )
{
	const dvec2 a( a2 - a1 );
	const dvec2 b( b2 - b1 );
...
{
	const auto cross2D = [] ( const dvec2& a, const dvec2& b )
	{
		return a.x * b.y - a.y * b.x;
	};


	const double cp1 = cross2D( b - a, p1 - a );
	const double cp2 = cross2D( b - a, p2 - a );
