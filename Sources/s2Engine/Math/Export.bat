...
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Math_API.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Box.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Compute.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Interpolator.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Math.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Plane.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\ProjectionTransform.h .
copy /Y   %BASEDIR_MODULE_SOURCES%\src\Ray.h .
