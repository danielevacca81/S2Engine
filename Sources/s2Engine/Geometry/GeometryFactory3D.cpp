...
MeshData3D GeometryFactory3D::createTeapot( int resU, int resV )
{
	...
	static constexpr std::array<std::array<std::array<uint16_t, 4>, 4>, TEAPOT_NUM_PATCHES> TEAPOT_PATCHES = { {
			// Rim
