// ViewPerspective.h
//
#ifndef RENDERENGINE_VIEWPERSPECTIVE_H
#define RENDERENGINE_VIEWPERSPECTIVE_H
...
class RENDERPIPELINE_API ViewPerspective
{
public:
	ViewPerspective();
...
#endif // RENDERENGINE_VIEWPERSPECTIVE_H
