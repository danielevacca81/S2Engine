...
bool S2COMMON_API lineIntersection
(
	const Math::dvec2 &a1, 
	const Math::dvec2 &a2,
	const Math::dvec2 &b1,
...
bool S2COMMON_API lineBoxIntersection( 
	const Math::dvec3 &p0,
	const Math::dvec3 &p1, 
	const Math::box3 &b );
...
bool S2COMMON_API pointsOnSameSideOfLine
(
	const Math::dvec2 &p1,
	const Math::dvec2 &p2, 
	const Math::dvec2 &a,
...
bool S2COMMON_API pointBelongsToTriangle
(
	const Math::dvec2 &p,
	const Math::dvec2 &a1, 
	const Math::dvec2 &a2,
...
bool S2COMMON_API triangles2DIntersection
(
	const Math::dvec2 &a1, 
	const Math::dvec2 &a2,
	const Math::dvec2 &a3,
...
bool S2COMMON_API triangleBox2DIntersection
(
	const Math::dvec2 &a1, 
	const Math::dvec2 &a2,
	const Math::dvec2 &a3,
