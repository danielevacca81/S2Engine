...
, _usageHint(BufferObject::StaticDraw)
{}
...
{
	VertexBuffer buf( points.size() * sizeof(Math::vec3), _usageHint );
...
// ------------------------------------------------------------------------------------------------
void Mesh::setColors( const std::vector<s2::Color>   &colors   )
{
	VertexBuffer buf( colors.size() * sizeof(s2::Color), _usageHint );
	buf.sendData( (void*)(&colors[0]), colors.size() * sizeof(s2::Color), 0 );
...
{
	VertexBuffer buf( normals.size() * sizeof(Math::vec3), _usageHint );
...
{
	VertexBuffer buf( texCoords.size() * sizeof(Math::vec2), _usageHint );
