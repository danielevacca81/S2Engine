...
// -----------------------------------------------------------------------------------------------
void Texture1D::create( int channelCount, DataFormat format, DataType type, bool mipmaps, int   width, void *pixels)
{
	Texture::create();
...
// -----------------------------------------------------------------------------------------------
void Texture2D::create( int channelCount, DataFormat format, DataType type, bool mipmaps, int width, int height, void *pixels )
{
	Texture::create();
