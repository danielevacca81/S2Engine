...
/*                                             Texture                                          */
/************************************************************************************************/
class S2RENDERER_API Texture : public std::enable_shared_from_this<Texture>
{
public:
	// -----------------------------------------------------------------------------------------------
	enum  DataFormat
...
public:
	...
	// Custom methods
	virtual void	setMinFilter( TextureMinFilter minFilter );
	virtual void	setMagFilter( TextureMagFilter magFilter );
	virtual void	setWrapMode ( WrapMode wrap );
...
/*                                          Texture1D                                           */
/************************************************************************************************/
class S2RENDERER_API Texture1D : public Texture
{
protected:
	int _textureWidth;
...
public:	
	...
	static Texture1DPtr New(int channelCount,DataFormat format,DataType type,bool mipmaps,int width,void *pixels)
...
/*                                          Texture2D                                           */
/************************************************************************************************/
class S2RENDERER_API Texture2D : public Texture
{
protected:
	int _textureWidth;
	int _textureHeight;
...
public:	
	...
	static Texture2DPtr New(int channelCount,DataFormat format,DataType type,bool mipmaps, bool border,int width,int height,void *pixels)
