...
void TextRenderer::draw( OpenGL::Renderer *r )
{
	...
	*/
	...
	//for( int i=-10; i<10; ++i )
	//{
	//	vb << OpenGL::Vertex( Math::dvec3( i, -10, 0 ), Math::vec3(), Math::vec2(), i>=0 ? s2::Color::white():s2::Color::blue() );
	//	vb << OpenGL::Vertex( Math::dvec3( i,  10, 0 ), Math::vec3(), Math::vec2(), i>=0 ? s2::Color::white():s2::Color::blue() );
	//}

	//for( int i=-10; i<10; ++i )
	//{
	//	vb << OpenGL::Vertex( Math::dvec3( -10, i, 0 ), Math::vec3(), Math::vec2(), i>=0 ? s2::Color::white():s2::Color::blue() );
	//	vb << OpenGL::Vertex( Math::dvec3(  10, i, 0 ), Math::vec3(), Math::vec2(), i>=0 ? s2::Color::white():s2::Color::blue() );
	//}
